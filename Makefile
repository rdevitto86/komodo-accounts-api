...
VERSION ?= latest
AWS_SECRET_PREFIX := ${APP_NAME}/$(ENV)
...
help:
	...
	@echo "  dev      - Development (LocalStack)"
	@echo "  staging  - Staging (real AWS)"
	@echo "  prod     - Production (real AWS)"
	@echo ""
	@echo "Examples:"
...
build:
	@echo "Building $(APP_NAME) public + internal images for ENV=$(ENV)"
	@ENV=$(ENV) \
	APP_NAME=$(APP_NAME) \
	VERSION=$(TAG) \
