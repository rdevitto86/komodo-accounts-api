...
var Err = AccountAPIErrors{
	NotFound:                    httpErr.ErrorCode{ID: httpErr.CodeID(httpErr.RangeUser, 1), Status: http.StatusNotFound, Message: "Account not found"},
	AlreadyExists:               httpErr.ErrorCode{ID: httpErr.CodeID(httpErr.RangeUser, 2), Status: http.StatusConflict, Message: "Account already exists"},
